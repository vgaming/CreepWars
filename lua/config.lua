...
creepwars_gold_per_kill = function(team_creep_score, unit)
	if unit.variables["creepwars_creep"] == true then
		return 3 + unit.__cfg.level * 2
	elseif unit.canrecruit == true then
