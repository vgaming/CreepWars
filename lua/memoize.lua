...
wesnoth.message("Development Creep Wars", "Changelog: 1. Add more creep types 2. Increase creep strength. 3. lvl3+ boosting decreased 4. Visual ability added for lvl3+ boost.")
